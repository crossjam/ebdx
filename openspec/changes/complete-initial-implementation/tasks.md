...
- [x] 1.2 Delete `tests/test_placeholder.py` and confirm `poe test` still collects and passes with the fixture smoke-test module as the only remaining test file
